...
\usetikzlibrary{calc,decorations.pathreplacing, arrows.meta, positioning, external, patterns, decorations.markings,angles, quotes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
    ...
    \input{preLectureNotes/inputPrelec.tex}
